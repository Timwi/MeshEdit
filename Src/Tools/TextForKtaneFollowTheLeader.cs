...
namespace MeshEdit
{
    ...
    {
        [Tool("Text (KTANE, Follow The Leader)")]
        public static void TextForKtaneFollowTheLeader()
        {
            TextForKtaneFollowTheLeaderUtil.Execute();
        }

        sealed class TextForKtaneFollowTheLeaderUtil
        {
            ...
            private static PointD rot(PointD p) { return new PointD(p.Y, -p.X); }
        }
    }
}
